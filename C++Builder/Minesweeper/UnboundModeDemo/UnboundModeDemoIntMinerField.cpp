...
void __fastcall TIntMinerField::MouseDownHandler(System::TObject* Sender, Controls::TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ACol, ARow;
...
void __fastcall TIntMinerField::MouseMoveHandler(System::TObject* Sender, TShiftState Shift, int X, int Y)
{
  int ACol, ARow;
  MouseToCell(X, Y, ACol, ARow);
  if((ACol == - 1) || (ARow == -1)) {
...
void __fastcall TIntMinerField::MouseUpHandler(System::TObject* Sender, Controls::TMouseButton Button, TShiftState Shift, int X, int Y)
{
  int ACol, ARow;
...
__fastcall TIntMinerField::TIntMinerField(TComponent* AOwner, TMinerField* AMinerField) : TObject()
{
