...
private:
  ...
  bool FSurprised;
  TNotifyEvent FCreateNewGameEvent;
  ...
  void __fastcall MouseDownHandler(System::TObject* Sender, Controls::TMouseButton Button, TShiftState Shift, int X, int Y);
  void __fastcall MouseMoveHandler(System::TObject* Sender, TShiftState Shift, int X, int Y);
  void __fastcall MouseUpHandler(System::TObject* Sender, Controls::TMouseButton Button, TShiftState Shift, int X, int Y);
...
public:
  __fastcall TIntMinerField(TComponent* AOwner, TMinerField* AMinerField);
